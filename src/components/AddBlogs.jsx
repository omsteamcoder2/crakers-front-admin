...
const AddBlog = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("metaDescription", metaDescription || content.substring(0, 160))
    formData.append("keywords", keywords)
    formData.append("ogTitle", ogTitle || title)
    formData.append("ogDescription", ogDescription || content.substring(0, 160))
    ...
    try {
      await axios.post(`${API_BASE_URL}/api/add-blog`, formData)
      setIsSubmitting(false)
      ...
      <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
          <div className="p-4 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
            ...
            <p className="text-sm text-blue-100">Enter the details for your new blog post</p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">OpenGraph Image</label>
              <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center hover:border-blue-500 transition-colors">
                ...
                <label htmlFor="og-image" className="cursor-pointer flex flex-col items-center justify-center">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">
                    {ogImagePreview ? "Click to change image" : "Click to upload OpenGraph image"}
                  </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
          <div className="p-4 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
            ...
            <p className="text-sm text-blue-100">Upload images for your blog post</p>
          </div>
            ...
            {preview.length > 0 && (
              <div className="mt-6">
                <div className="flex justify-between items-center mb-3">
                  <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Image Preview ({preview.length})</h3>
                  {preview.length > 1 && (
                    <button
                      type="button"
                      onClick={() => {
