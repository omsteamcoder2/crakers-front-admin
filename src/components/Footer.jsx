    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8 md:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 border-b border-red-800 pb-2 inline-block">
              Quick Links
            </h3>
            <ul className="space-y-1 md:space-y-2">
              {["Home", "About us", "Services", "Projects", "Gallery", "Blog", "Contact"].map((item) => (
                <li key={item}>
                  <Link
                    to={item === "Home" ? "/" : `/${item.toLowerCase().replace(" ", "-")}`}
                    onClick={item === "Home" ? scrollToTop : undefined}
                    className="text-sm md:text-base text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-300 flex items-center"
                  >
                    <svg
                      className="w-3 h-3 md:w-4 md:h-4 mr-1 md:mr-2 text-red-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
            ...
            <ul className="space-y-1 md:space-y-2">
              {[
                ...
                <li key={service}>
                  ...
                  >
                    <svg
                      className="w-3 h-3 md:w-4 md:h-4 mr-1 md:mr-2 text-red-500 flex-shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3 text-red-500 flex-shrink-0 mt-0.5"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-sm md:text-base text-gray-300">
                  123 Construction Avenue, Chennai, Tamil Nadu, India
                </span>
              </li>
              <li className="flex items-center">
                <svg
                  className="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3 text-red-500 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="flex items-center">
                ...
                <span className="text-sm md:text-base text-gray-300 break-all">info@rfconstruction.com</span>
              </li>
              <li className="flex items-center">
                <svg
                  className="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3 text-red-500 flex-shrink-0"
                ...
                <span className="text-sm md:text-base text-gray-300">Mon-Sat: 9:00 AM - 6:00 PM</span>
              </li>
            </ul>
          </div>
        </div>
