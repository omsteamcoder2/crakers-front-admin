...
const AddService = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_BASE_URL}/api/add-service`, formData)
      setIsSubmitting(false)
  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-6 px-1">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Create New Service</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
          <div className="p-4 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
            ...
            <p className="text-sm text-blue-100">Enter the details for your new service</p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
          <div className="p-4 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
            ...
            <p className="text-sm text-blue-100">Upload images for your service</p>
          </div>
